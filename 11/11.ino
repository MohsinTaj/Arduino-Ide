...
if(bt_ir_data > 60){Speed = bt_ir_data;}      
}
...
delay(100);
     ...
     if(bt_ir_data == 8){mode=0; Speed=255; Stop();}    //Manual Android Application and IR Remote Control Command   
...
//===============================================================================    
else if(bt_ir_data == 'c'){turnLeft(); Speed=255;   bt_ir_data = A5;}
else if(bt_ir_data == 'd'){turnRight(); Speed=255;  bt_ir_data = A5;}
else if(bt_ir_data == 'b'){backword(); Speed=255;    bt_ir_data = A5;}  // if the bt_data is '2' the motor will Reverse
else if(bt_ir_data == 'a'){forword(); Speed=255;    bt_ir_data = A5;}  // if the bt_data is '1' the DC motor will go forward
}
