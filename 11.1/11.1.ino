...
//===============================================================================    
else if(bt_ir_data == 'a'){turnLeft(); } 
else if(bt_ir_data == 'b'){turnRight(); }
}
...
long IRremote_data(){
     if(results.value==0xFF02FD){IR_data='a';}  
else if(results.value==0xFF9867){IR_data='b';} 
else if(results.value==0xFFE01F){IR_data='c';} 
else if(results.value==0xFF906F){IR_data='d';} 
